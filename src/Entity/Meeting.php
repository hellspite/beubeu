...
class Meeting
{
    ...
    */
    ...
    /**
    * @Vich\UploadableField(mapping="meeting_images", fileNameProperty="image")
    * @var File
    */
    private $imageFile;
    ...
    */
    ...
    /**
    * @Vich\UploadableField(mapping="meeting_images", fileNameProperty="gallery1")
    * @var File
    */
    ...
    */
    ...
    /**
    * @Vich\UploadableField(mapping="meeting_images", fileNameProperty="gallery2")
    * @var File
    */
    ...
    */
    ...
    /**
    * @Vich\UploadableField(mapping="meeting_images", fileNameProperty="gallery3")
    * @var File
    */
    ...
    */
    public function deleteNews($args){
        $em = $args->getEntityManager();
        $news = $em->getRepository(News::class)->findOneBySourceId($this->getId(), 'Meeting');
